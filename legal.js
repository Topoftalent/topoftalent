...
var LEGAL = {
  terminos: {
    ...
    sections: [
      ...
      {h:'9. Ley Aplicable y Jurisdicción', p:'Los presentes términos se rigen por la legislación ecuatoriana aplicable, complementada por la normativa de la Unión Europea en lo que corresponda a los operadores con base en Europa. Cualquier controversia se someterá a los tribunales competentes.'},
